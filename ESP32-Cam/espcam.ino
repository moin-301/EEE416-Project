...
const char* ssid     = "Room 4004 (2)";   //your network SSID
const char* password = "room4004";   //your network password

String myScript = "/macros/s/AKfycbzHHtLMZCg1tRn9oWzASPNIbDI5VS7abcRPQiDY-Kabs9Nkkrk/exec";    //Create your Google Apps Script and replace the "myScript" path.
